...
const Page = props => (
  <div>
    <PageTitle text="Children" />

    <p>
      Generally speaking, you are free to name your props the way you want.
      However there is one name you should not use for your own props:{' '}
      ...
      the opening tag and the closing tag of the component.
    </p>
    ...
    <p>
      Not only does it feel more like writing HTML, but it also enables us to
      render inner components if we need to (links, icons…). To do so, we can
      access the content passed between tags with <code>props.children</code>.
    </p>
    ...
    <p>
      Pass a link to the a URL to the following <code>Title</code> component
      without updating the component definition itself – just by using{' '}
      <code>children</code>.
    </p>
